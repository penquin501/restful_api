...
/**
 * PostinfoZipcodesBackup
 *
 * @ORM\Table(name="postinfo_zipcodes_backup", indexes={@ORM\Index(name="idx_zip_distr", columns={"zipcode", "district_code"}), @ORM\Index(name="idx_distr_zip", columns={"district_code", "zipcode"}), @ORM\Index(name="idx_distr", columns={"district_code"})})
 * @ORM\Entity
 */
class PostinfoZipcodesBackup
{
    /**
     * @var int
     *
