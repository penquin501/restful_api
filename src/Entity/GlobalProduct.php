 ...
 * GlobalProduct
 *
 * @ORM\Table(name="global_product", indexes={@ORM\Index(name="takeorderby_productid_idx", columns={"productid"}), @ORM\Index(name="productid_idx", columns={"productid"}), @ORM\Index(name="takeorderby_productid_productstatus_idx", columns={"productid", "productstatus"}), @ORM\Index(name="authen_group", columns={"authen_group"})})
 * @ORM\Entity
 */
class GlobalProduct
{
     ...
     * @var string
     *
     * @ORM\Column(name="peak_sent", type="string", length=0, nullable=false, options={"default"="no"})
     */
    private $peakSent = 'no';
     ...
     * @var string
     *
     * @ORM\Column(name="peak_net_price", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $peakNetPrice = '0';

    /**
     * @var string
     *
     * @ORM\Column(name="peak_price", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $peakPrice = '0';
     ...
     * @var string
     *
     * @ORM\Column(name="peak_deliverry_price", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $peakDeliverryPrice = '0';

    /**
     * @var string
     *
     * @ORM\Column(name="peak_service_price", type="decimal", precision=10, scale=0, nullable=false)
     */
    private $peakServicePrice = '0';

    /**
     * @var string
     *
     * @ORM\Column(name="peak_include_vat", type="string", length=0, nullable=false, options={"default"="no"})
     */
    private $peakIncludeVat = 'no';
    ...
    public function getPeakSent(): ?string
    {
        return $this->peakSent;
    }

    public function setPeakSent(string $peakSent): self
    {
        $this->peakSent = $peakSent;
    ...
    public function getPeakNetPrice(): ?string
    {
        return $this->peakNetPrice;
    }

    public function setPeakNetPrice(string $peakNetPrice): self
    {
        $this->peakNetPrice = $peakNetPrice;

        return $this;
    }

    public function getPeakPrice(): ?string
    {
        return $this->peakPrice;
    }

    public function setPeakPrice(string $peakPrice): self
    {
    ...
    public function getPeakDeliverryPrice(): ?string
    {
        return $this->peakDeliverryPrice;
    }

    public function setPeakDeliverryPrice(string $peakDeliverryPrice): self
    {
        $this->peakDeliverryPrice = $peakDeliverryPrice;

        return $this;
    }

    public function getPeakServicePrice(): ?string
    {
        return $this->peakServicePrice;
    }

    public function setPeakServicePrice(string $peakServicePrice): self
    {
    ...
    public function getPeakIncludeVat(): ?string
    {
        return $this->peakIncludeVat;
    }

    public function setPeakIncludeVat(string $peakIncludeVat): self
    {
        $this->peakIncludeVat = $peakIncludeVat;
