 ...
 * WZipcodes
 *
 * @ORM\Table(name="w_zipcodes", indexes={@ORM\Index(name="idx_zip_distr", columns={"zipcode", "district_code"}), @ORM\Index(name="idx_distr_zip", columns={"district_code", "zipcode"}), @ORM\Index(name="idx_distr", columns={"district_code"})})
 * @ORM\Entity
 */
class WZipcodes
{
