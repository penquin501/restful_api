 ...
 * GlobalProductImage1
 *
 * @ORM\Table(name="global_product_image1", indexes={@ORM\Index(name="productcode_takeorderby_idx", columns={"productcode", "createby"}), @ORM\Index(name="productcode_takeorderby_mainimage_indeximage_idx", columns={"productcode", "createby", "mainimage", "indeximage"}), @ORM\Index(name="takeorderby_idx", columns={"createby"})})
 * @ORM\Entity
 */
class GlobalProductImage1
{
    /**
     * @var int
     *
