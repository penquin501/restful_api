 ...
 *
 * @ORM\Table(name="merchant_product_stock", indexes={@ORM\Index(name="productid_takeorderby_idx", columns={"productid", "takeorderby"}), @ORM\Index(name="takeorderby_idx", columns={"takeorderby"})})
 * @ORM\Entity
 */
class MerchantProductStock
{
    /**
     * @var string
     *
