 ...
 * GlobalAuthen1
 *
 * @ORM\Table(name="global_authen1", indexes={@ORM\Index(name="uname", columns={"uname"}), @ORM\Index(name="id", columns={"id"}), @ORM\Index(name="uname_pwrd", columns={"uname", "pwrd"}), @ORM\Index(name="merid_idx", columns={"merid"}), @ORM\Index(name="merid_uid", columns={"merid", "id"})})
 * @ORM\Entity
 */
class GlobalAuthen1
{
